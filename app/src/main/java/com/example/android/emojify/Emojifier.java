...
class Emojifier {
    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        // COMPLETED (3): Change the name of the detectFaces() method to detectFacesAndOverlayEmoji()
        ...
        // COMPLETED (7): Create a variable called resultBitmap and initialize it to the original
        ...
        if(faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                // COMPLETED (4): Create a variable called emojiBitmap to hold the appropriate
                // Emoji bitmap and remove the call to whichEmoji()
                Resources res = context.getResources();
                Bitmap emojiBitmap = BitmapFactory.decodeResource(res, R.drawable.smile);

                // COMPLETED (5): Create a switch statement on the result of the whichEmoji() call,
                // and assign the proper emoji bitmap to the variable you created
    ...
    // COMPLETED (6) Create a method called addBitmapToFace() which takes the background bitmap,
    // the Emoji bitmap, and a Face object as arguments and returns the combined bitmap with the
    // Emoji over the face.
    private static Bitmap addBitmapToFace(Bitmap originalBitmap, Bitmap emojiBitmap, Face face) {
